      ...
      select: function () {
        var e, i = "请选择", a = "layui-form-select", n = "layui-select-title", r = "layui-select-none", d = "",
          f = u.find("select"), v = function (i, l) {
            ...
            var y, p = t(this), m = i.find("." + n), k = m.find("input"), g = i.find("dl"), x = g.children("dd"),
...
layui.define(["laytpl", "form"], function (e) {
  ...
  var a = layui.$, t = layui.laytpl, n = layui.form, i = "transfer", l = {
    ...
    u = "layui-transfer-header", h = "layui-transfer-search", f = "layui-transfer-active", y = "layui-transfer-data",
    p = function (e) {
...
layui.define("jquery", function (e) {
  ...
  !function (e, t, i) {
    ...
    var a, o = e([]), r = e.resize = e.extend(e.resize, {}), l = "setTimeout", c = "resize", u = c + "-special-event",
